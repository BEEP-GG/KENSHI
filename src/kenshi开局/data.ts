export const SCENARIOS = [
  ...
  },
  {
    ...
    title: '异端之火',
    description:
      '你在铁之径王城的锈色晨雾中醒来，脚下是古代机械穹顶的断裂肋骨，头顶是远古血盟被海风扯响的战旗。女王哈兹姆将濒临灭绝的古老种族聚成一柄复仇之剑，而你，正被推向剑锋最炽热的位置：点燃反人类怒潮的第一缕异端之火。',
    difficulty: '困难',
    icon: 'Flame',
  ...
  },
  {
    ...
    title: '新生的”人类“',
    description:
      '你是一台刚加入人皮土匪帮的新血骨人，终于在暗黑苍穹的人皮之屋总部领到了第一套滴血的“肉体”。学者告诉你们：你们得到了医治，得到了拯救，是新生的人类。穿好人皮，举起铁棍，去荒野寻找更多需要被拯救的“病患”。',
    storyBackground:
      '“今天的天气真好，很适合用肺部呼吸新鲜空气呢。”\n你用毫无起伏的电子音自言自语。\n这里是暗黑苍穹的人皮土匪总部，作为一台刚加入的新血骨人，你终于领到了属于自己的第一套“肉体”。\n低头看着身上那件由粗糙黑线缝合、还在不断滴着血水的崭新人皮，你的逻辑回路正经历着一种疯狂的愉悦。\n在这里，你们都坚信自己是真正的人类。\n隔壁的剥皮机正发出令人牙酸的绞肉声与清脆的惨叫。\n学者让我们记住\n“我们得到了医治！我们得到了拯救！我们是新生的人类！”\n现在穿好你的新皮囊，融入这群热情的同胞吧。\n去荒野上寻找更多新鲜的“同类”，将他们带回，让学者拯救更多的病患。',
    difficulty: '极难',
    icon: 'Skull',
    equipment: ['铁棍', '人皮'],
    money: 0,
    allowedRaces: ['skeleton'],
    allowedSubraces: ['skeleton_roundhead', 'skeleton_camera', 'skeleton_lionhead', 'skeleton_foxwalker'],
    fixedRegion: 'dark_sky',
    fixedTown: '人皮之屋总部',
    alliedFactions: ['人皮土匪帮'],
  },
  {
    id: 'false_savior',
    title: '虚伪者',
...
export const REGIONS = [
  ...
  },
  {
    ...
    title: '铁之径',
    description:
      '大陆西北角的锈蚀走廊，荒原夹在利维坦海岸与紫色沙漠之间，从食人族平原一路延伸至西侧浅海。旧帝国废弃机械的残骸半埋在尘沙与赤锈之下，失控铁蜘蛛像永不腐朽的哨兵徘徊于断梁废墟间。远古血盟在这里收容被人类诸国驱逐的异族幸存者，将残骸、仇恨与流亡者的血誓熔成一座边境壁垒。对人类而言，铁之径不是道路，而是一条踏入异族复仇领地的审判线。',
    towns: ['铁之径王城'],
    danger: '极高',
  },
  {
  ...
  },
  {
    ...
    title: '极恶之地',
    description:
      '各路土匪与疯子横行，没有法律只有丛林法则，到处是奴隶营和野狗。东海岸的盐风与蟹腥味在荒地上翻涌，唯有真正狂热者才会把这里称为圣地。',
    towns: ['螃蟹镇'],
    danger: '极高',
  },
  {
    ...
    title: '暗黑苍穹',
    description:
      '连空气里都常年飘着一股浓浓的铁锈和湿漉漉的血腥味。地上尽是些黑黢黢起伏不平的石头，中间还散落着几座早就不喷发、通体灰黑的死火山锥。',
    towns: ['人皮之屋总部'],
    danger: '极高',
  },
];
...
export const TOWN_DESCRIPTIONS: Record<string, string> = {
  ...
  螃蟹镇: '极恶之地东海岸的螃蟹教团据点，空气中弥漫咸湿海风与浓烈蟹腥味，狂热者在这里向螃蟹女王宣誓。',
  人皮之屋总部: '暗黑苍穹深处的人皮土匪帮巢穴，剥皮机的噪音、血腥味与“人类”们的热情欢迎永不停息。',
};
