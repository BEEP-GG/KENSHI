...
export const REGIONS = [
  ...
  },
  {
    ...
    title: '铁之径',
    description:
      '大陆西北角偏僻而充满敌意的锈蚀走廊，夹在利维坦海岸与紫色沙漠之间，从食人族平原一路延伸向西侧浅海。旧帝国废弃机械的残骸半埋在尘沙与锈土中，静止的铁蜘蛛像死去的哨兵伏在荒原两侧。远古血盟占据此地后，将这里铸成异族流亡者的壁垒与复仇熔炉；对人类而言，铁之径不是道路，而是一条通往绝地的审判线。',
    towns: ['铁之径王城'],
    danger: '极高',
  },
  {
...
export const TOWN_DESCRIPTIONS: Record<string, string> = {
  ...
  铁之径王城:
    '铁之径西侧浅海岛屿上的异族王城，坐标为纬度 7348、经度 1138。它并非传统意义上的宫城，而是一座寄生在古代机械穹顶废墟上的战争巢穴：断裂的金属肋骨撑起城墙，粗犷石块与废旧铁皮填补着残骸缺口，巡逻者的火把在锈尘与海雾间明灭。绘有各异族图腾的破旧旗帜终年猎猎作响，女王哈兹姆的号令则从穹顶深处传出，将流亡者、幸存者与复仇者凝聚成远古血盟最锋利的獠牙。',
};
