...
export const StepRegion: React.FC<StepRegionProps> = ({ data, updateData }) => {
  ...
  return (
    <div className="h-full min-h-0 overflow-hidden flex flex-col lg:flex-row lg:items-start gap-8">
      <div className="w-full lg:w-1/3 min-h-0 lg:h-[calc(100vh-240px)] flex flex-col">
        <h2 className="text-3xl font-serif text-white mb-4 shrink-0">出生区域</h2>

        <div className="min-h-0 flex-1 overflow-y-auto pr-2 max-h-[60vh] lg:max-h-none">
